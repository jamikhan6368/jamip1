// lib/automation.js - V114: FULL AUTOMATION ENGINE + PRO UI

module.exports = `
(() => {
  // Prevent double loading
  if (window.runwayProInjected) return;
  window.runwayProInjected = true;
          ...
          <div class="header">
            ...
            <div style="display:flex; gap:8px; align-items:center;">
                <div class="social-row">
                   <a href="#" class="social-btn">YT</a><a href="#" class="social-btn">WA</a>
                </div>
  ...
  function startTraining(target) {
      alert(\`Click on the \${target} element now.\`);
      const handler = (e) => {

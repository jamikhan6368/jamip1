// lib/automation.js - V116: FULL UNTRIMMED APP
...
(() => {
  ...
  function createFloatingUI() {
      ...
      // NOTE: All backticks inside the string are escaped with backslash (\\)
      style.textContent = \`
      ...
      panel.innerHTML = \`
        <div class="app-shell">
          <div class="header">
            <div><div class="brand-title">Runway Pro</div><div class="brand-subtitle">Automation Suite</div></div>
            <div class="header-right">
               ...
               <div class="control-icon" id="theme-btn" title="Theme">\${STATE.theme==='dark' ? '☀️' : '🌙'}</div>
